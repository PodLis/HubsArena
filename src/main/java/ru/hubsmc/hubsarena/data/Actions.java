...
public enum Actions {
    ...
    SHOOT1(ClickType.RIGHT, Items.COWBOY_PISTOL_1, 5, 0),
    SHOOT2(ClickType.RIGHT, Items.COWBOY_PISTOL_2, 5, 0),
    SHOOT3(ClickType.RIGHT, Items.COWBOY_PISTOL_3, 5, 0),
    SHOOT4(ClickType.RIGHT, Items.COWBOY_PISTOL_4, 5, 0),
    SHOOT5(ClickType.RIGHT, Items.COWBOY_PISTOL_5, 5, 0),

    LOAD0(ClickType.LEFT, Items.COWBOY_PISTOL_0, 20, 0),
    LOAD1(ClickType.LEFT, Items.COWBOY_PISTOL_1, 20, 0),
    LOAD2(ClickType.LEFT, Items.COWBOY_PISTOL_2, 20, 0),
    LOAD3(ClickType.LEFT, Items.COWBOY_PISTOL_3, 20, 0),
    LOAD4(ClickType.LEFT, Items.COWBOY_PISTOL_4, 20, 0),
